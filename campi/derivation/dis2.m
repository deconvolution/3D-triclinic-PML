eqd=subs(eq,[... pux
    ...
    (uxd(3,3,4,3)-uxd(3,3,3,3))/dz, ...
    (uxd(3,3,3,3)-uxd(3,3,3,2))/dt, ...
    ...p^2 ux
    ...
    (uxd(3,3,4,3)-uxd(3,3,3,3)-uxd(3,3,4,2)+uxd(3,3,3,2))/dt/dz,...
    ...p^3 ux
    ...
    (uyd(3,3,4,3)-uyd(3,3,3,3))/dz, ...
    (uyd(3,3,3,3)-uyd(3,3,3,2))/dt, ...
    ...p^2 uy
    ...
    (uyd(3,3,4,3)-uyd(3,3,3,3)-uyd(3,3,4,2)+uyd(3,3,3,2))/dt/dz,...
    ...p^3 uy
    ...
    (uzd(3,3,4,3)-uzd(3,3,3,3))/dz, ...
    (uzd(3,3,3,3)-uzd(3,3,3,2))/dt, ...
    ...p^2 uz
    ...
    (uzd(3,3,4,3)-uzd(3,3,3,3)-uzd(3,3,4,2)+uzd(3,3,3,2))/dt/dz,...
    ...p^3 uz
